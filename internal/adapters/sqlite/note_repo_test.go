...
func TestNoteRepository_GetByID(t *testing.T) {
	...
	note := createTestNote(t, repo, ctx, "MISSION-001", "Test Note", "Content")
...
func TestNoteRepository_List(t *testing.T) {
	...
	createTestNote(t, repo, ctx, "MISSION-001", "Note 2", "")
	createTestNote(t, repo, ctx, "MISSION-001", "Note 3", "")
...
func TestNoteRepository_List_FilterByType(t *testing.T) {
	...
	n1 := createTestNote(t, repo, ctx, "MISSION-001", "Note 1", "")
	n2 := createTestNote(t, repo, ctx, "MISSION-001", "Note 2", "")
	createTestNote(t, repo, ctx, "MISSION-001", "Note 3", "")
...
func TestNoteRepository_List_FilterByMission(t *testing.T) {
	...
	if len(notes) != 1 {
		t.Errorf("expected 1 note for MISSION-001, got %d", len(notes))
	}
}
...
func TestNoteRepository_Update(t *testing.T) {
	...
	note := createTestNote(t, repo, ctx, "MISSION-001", "Original Title", "Original content")
...
func TestNoteRepository_Delete(t *testing.T) {
	...
	note := createTestNote(t, repo, ctx, "MISSION-001", "To Delete", "")
...
func TestNoteRepository_Pin_Unpin(t *testing.T) {
	...
	note := createTestNote(t, repo, ctx, "MISSION-001", "Pin Test", "")
...
func TestNoteRepository_GetNextID(t *testing.T) {
	...
	createTestNote(t, repo, ctx, "MISSION-001", "Test", "")
