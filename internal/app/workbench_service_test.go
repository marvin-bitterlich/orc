...
func newTestWorkbenchService() (*WorkbenchServiceImpl, *mockWorkbenchRepository, *mockWorkshopRepositoryForWorkbench, *mockRepoRepositoryForWorkbench, *mockEffectExecutor) {
	...
	service := NewWorkbenchService(workbenchRepo, workshopRepo, repoRepo, agentProvider, executor)
	return service, workbenchRepo, workshopRepo, repoRepo, executor
}
...
func TestWorkbenchService_CreateWorkbench(t *testing.T) {
	service, workbenchRepo, _, _, _ := newTestWorkbenchService()
...
func TestWorkbenchService_CreateWorkbench_AutoGeneratedName(t *testing.T) {
	service, workbenchRepo, _, repoRepo, _ := newTestWorkbenchService()
	ctx := context.Background()
...
func TestWorkbenchService_CreateWorkbench_WorkshopNotFound(t *testing.T) {
	service, _, _, _, _ := newTestWorkbenchService()
	ctx := context.Background()
...
func TestWorkbenchService_CreateWorkbench_ExecutesEffects(t *testing.T) {
	service, workbenchRepo, _, _, executor := newTestWorkbenchService()
	ctx := context.Background()
